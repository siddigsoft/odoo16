#!/bin/bash
################################################################################
# Script for installing OpenHRMS on Ubuntu 14.04, 15.04, 16.04 and 18.04 (could be used for other version too)
...
#-------------------------------------------------------------------------------
# Make a new file:
# sudo nano openhrms-install.sh
# Place this content in it and then make the file executable:
# sudo chmod +x openhrms_install.sh
# Execute the script to install Openhrms:
# ./openhrms_install.sh
################################################################################
...
ADMIN_EMAIL="openhrms@example.com"
##
...
echo -e "\n---- Installng pandas python dependency ---"
